...
class NEOInstaller:
    ...
    def _setup_user_setup(self):
        ...
        try:
            ...
            neo_user_setup_path = os.path.join(self.neo_install_dir, "scripts", "maya", "userSetup.py")
            ...
            if os.path.exists(user_setup_path):
                ...
                # No existing userSetup.py, just copy ours
                shutil.copy2(neo_user_setup_path, user_setup_path)
                print("✅ Created new userSetup.py")
