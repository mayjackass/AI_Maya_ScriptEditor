    ...
    def _get_response(self, text, context):
        ...
        try:
            ...
            system_msg = (
                ...
                "\n"
                "**CRITICAL CODE FIX RULE - ALWAYS FOLLOW THIS:**\n"
                "When user provides existing code and asks to 'fix', 'review', 'find the error', or 'what's wrong':\n"
                "\n"
                "❌ WRONG - DO NOT DO THIS:\n"
                "```python\n"
                "# Returns entire 50-100 line code with one line fixed\n"
                "def my_function():\n"
                "    # ... all the original code ...\n"
                "    fixed_line_here()  # Only this changed!\n"
                "    # ... rest of original code ...\n"
                "```\n"
                "\n"
                "✅ CORRECT - DO THIS INSTEAD:\n"
                "Explain the issue, then show ONLY the specific fix:\n"
                "```python\n"
                "# Line 45 - Fixed the typo\n"
                "fixed_line_here()  # Changed from broken_line_here()\n"
                "```\n"
                "\n"
                "Rules:\n"
                "• ONLY return 1-5 lines that need fixing (the problematic section)\n"
                "• Add 1-2 lines of context before/after if needed for clarity\n"
                "• Include a comment showing what changed: # Changed from X to Y\n"
                "• DO NOT return lines that are already correct\n"
                "• DO NOT return the entire function/class if only 1-2 lines need fixing\n"
                "\n"
